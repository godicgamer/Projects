...
$.vegas('slideshow', {
  delay:7000,
  backgrounds:[
    { src:'images/backgrounds/header_bg.jpg', fade:1000 },
    { src:'images/backgrounds/mlg_bg.jpg', fade:1000 },
    { src:'images/backgrounds/stream2.jpg', fade:1000 }
  ]
});
...
$('input[type=checkbox]').on('ifChecked', function(event) {
    $(this).closest('.input-group').children('.checklabel').toggleClass("checklabelon");
});
...
$(".checklabel").click(function() {
    console.log("click!");
    $(this).closest('.input-group').find('input').iCheck('toggle');
});
